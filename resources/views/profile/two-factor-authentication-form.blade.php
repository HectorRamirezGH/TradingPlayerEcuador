<x-jet-action-section>
    <x-slot name="title">
        <p class="text-gray-200">{{ __('Two Factor Authentication') }}</p>
    </x-slot>

    <x-slot name="description">
        <p class="text-gray-400">{{ __('Add additional security to your account using two factor authentication.') }}</p>
    </x-slot>
