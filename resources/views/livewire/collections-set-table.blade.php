                        ...
                        <li class="my-2 py-2 hover:bg-gray-100 rounded-lg px-2">
                            <div class="flex flex-row grid grid-cols-4 gap-6 place-items-center">
                                ...
                                <div class="flex flex-row">
                                    ...
                                    Visible
                                    @elseif($setcoleccionable->visible == 0)
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                ...
                                <div class="flex flex-col gap-2 place-items-center">
                                    <x-jet-button class="bg-blue-700 hover:bg-blue-800 text-center" wire:click="editSetModal({{ $setcoleccionable->id }})" wire:loading.attr="disabled">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                    </svg>
                                    </x-jet-button>
                                    <x-jet-button class="bg-rose-700 hover:bg-rose-800 text-center" wire:click="deleteSetModal({{ $setcoleccionable->id }})" wire:loading.attr="disabled">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
